...
import { Building, Edit, Mail, Shield, Trash2, User as UserIcon, Users } from 'lucide-react';
                ...
                <div className="flex items-center justify-between border-b border-gray-200 pb-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {permissions.includes('edit_users') && (
                            <Button size="sm" variant="outline" onClick={() => handleEdit(user)} className="flex cursor-pointer items-center gap-2">
